= IO extensions
:url-bmp-wiki: http://en.wikipedia.org/wiki/BMP_file_format
:url-jpeg-wiki: http://en.wikipedia.org/wiki/JPEG
:url-jpeg-lib: http://www.ijg.org/
:url-png-wiki: http://en.wikipedia.org/wiki/Portable_Network_Graphics
:url-png-lib: http://libpng.org/pub/png/libpng.html
:url-pnm-wiki: http://en.wikipedia.org/wiki/Portable_anymap
:url-raw-wiki: http://en.wikipedia.org/wiki/Raw_image_format
:url-targa-wiki: http://en.wikipedia.org/wiki/Truevision_TGA
:url-tiff-wiki: http://en.wikipedia.org/wiki/Tagged_Image_File_Format
:url-tiff-lib: http://www.remotesensing.org/libtiff/
:url-tiff-base-tags: http://www.awaresystems.be/imaging/tiff/tifftags/baseline.html
:url-tiff-extension-tags: http://www.awaresystems.be/imaging/tiff/tifftags/extension.html
:url-bmp-test-files: http://entropymine.com/jason/bmpsuite/
:url-png-test-files: http://www.schaik.com/pngsuite/pngsuite.html
:url-tiff-libtiff-test-files: http://www.remotesensing.org/libtiff/images.html
:url-tiff-graphicsmagick-test-files: ftp://ftp.graphicsmagick.org/pub/tiff-samples/tiff-sample-images-be.tar.gz
...
Please see the <<supported_image_formats,Supported Image Formats>> section for
all supported image formats. A basic tutorial is provided in the
...
For adding new image formats please refer to the
<<extending_gil_io_with_new_formats,Extending GIL::IO with new Formats>> section.
...
dependencies. Please see the <<supported_image_formats,Supported Image Formats>> section.
...
For more details please refer to the <<using_io,Using IO>> section.
...
under <<supported_image_formats,Supported Image Formats>>. A basic example follows:
...
Refer to the format specific sections under <<supported_image_formats,Supported Image Formats>>
to have a list of all the possible settings.
...
following link:{url-bmp-wiki}[BMP_Wiki].
...
following link:{url-jpeg-wiki}[JPEG_Wiki].

This jpeg extension is based on the libjpeg library which can be
found here, link:{url-jpeg-lib}[JPEG_Lib].
...
following link:{url-png-wiki}[PNG_Wiki].

This png extension is based on the libpng, which can be found
here, link:{url-png-lib}[PNG_Lib].
...
following link:{url-pnm-wiki}[PNM_Wiki]. No external library is needed for the pnm format.
...
For a general overview see link:{url-raw-wiki}[RAW_Wiki].
...
For a general overview of the BMP image file format go to the
following link:{url-targa-wiki}[TARGA_Wiki].
...
following link:{url-tiff-wiki}[TIFF_Wiki].

This tiff extension is based on the libtiff, which can be found, link:{url-tiff-lib}[TIFF_Lib].
...
* link:{url-tiff-base-tags}[TIFF_Base_Tags]
* link:{url-tiff-extension-tags}[TIFF_Extension_Tags]
...
[#extending_gil_io_with_new_formats]
...
BMP:: link:{url-bmp-test-files}[BMP_TEST_FILES] -- `BOOST_GIL_IO_USE_BMP_TEST_SUITE_IMAGES`
PNG:: link:{url-png-test-files}[PNG_TEST_FILES] -- `BOOST_GIL_IO_USE_PNG_TEST_SUITE_IMAGES`
PNM:: request files from me -- `BOOST_GIL_IO_USE_PNM_TEST_SUITE_IMAGES`
TIFF:: link:{url-tiff-libtiff-test-files}[TIFF_LIB_TIFF_TEST_FILES] -- `BOOST_GIL_IO_USE_TIFF_LIBTIFF_TEST_SUITE_IMAGES`
TIFF:: link:{url-tiff-graphicsmagick-test-files}[TIFF_GRAPHICSMAGICK_TEST_FILES] -- `BOOST_GIL_IO_USE_TIFF_GRAPHICSMAGICK_TEST_SUITE_IMAGES`
