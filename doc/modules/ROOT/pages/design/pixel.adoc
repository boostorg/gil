...
from color bases: pixels may be _homogeneous_ if all of their channels
have the same type; otherwise they are called _heterogeneous_. The
...
well. Two pixels are _compatible_ if their color spaces are the same
...
A pixel is _convertible_ to a second pixel if it is possible to
...
* link:../reference/structboost_1_1gil_1_1_pixel_based_concept.html[PixelBasedConcept<P>]
* link:../reference/structboost_1_1gil_1_1_pixel_concept.html[PixelConcept<Pixel>]
* link:../reference/structboost_1_1gil_1_1_mutable_pixel_concept.html[MutablePixelConcept<Pixel>]
* link:../reference/structboost_1_1gil_1_1_pixel_value_concept.html[PixelValueConcept<Pixel>]
* link:../reference/structboost_1_1gil_1_1_homogeneous_pixel_based_concept.html[HomogeneousPixelConcept<Pixel>]
* link:../reference/structboost_1_1gil_1_1_mutable_homogeneous_pixel_concept.html[MutableHomogeneousPixelConcept<Pixel>]
* link:../reference/structboost_1_1gil_1_1_homogeneous_pixel_value_concept.html[HomogeneousPixelValueConcept<Pixel>]
* link:../reference/structboost_1_1gil_1_1_pixels_compatible_concept.html[PixelsCompatibleConcept<Pixel1, Pixel2>]
* link:../reference/structboost_1_1gil_1_1_pixel_convertible_concept.html[PixelConvertibleConcept<SrcPixel, DstPixel>]
====
