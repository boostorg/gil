...
* link:../reference/group___pixel_iterator_concept_pixel_iterator.html[PixelIteratorConcept<Iterator>]
* link:../reference/structboost_1_1gil_1_1_mutable_pixel_iterator_concept.html[MutablePixelIteratorConcept<Iterator>]
====
...
* link:../reference/structboost_1_1gil_1_1_iterator_adaptor_concept.html[IteratorAdaptorConcept<Iterator>]
* link:../reference/structboost_1_1gil_1_1_mutable_iterator_adaptor_concept.html[MutableIteratorAdaptorConcept<Iterator>]
====
...
- `memory_based_step_iterator<Iterator>`: An iterator adaptor that changes
  ...
  (see xref:design/pixel_iterator.adoc#_step_iterator[Step Iterator])
...
- `dereference_iterator_adaptor<Iterator,Fn>`: An iterator that applies a
  ...
  See xref:design/image_view.adoc[image_view] for more. The unary function `Fn` must
...
* link:../reference/structboost_1_1gil_1_1_step_iterator_concept.html[StepIteratorConcept<Iterator>]
* link:../reference/structboost_1_1gil_1_1_mutable_step_iterator_concept.html[MutableStepIteratorConcept<Iterator>]
* link:../reference/structboost_1_1gil_1_1_memory_based_iterator_concept.html[MemoryBasedIteratorConcept<Iterator>]
* link:../reference/structboost_1_1gil_1_1_has_dynamic_x_step_type_concept.html[HasDynamicXStepTypeConcept<T>]
====
