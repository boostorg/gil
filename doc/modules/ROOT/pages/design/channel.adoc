...
* xref:reference:boost/gil/ChannelConcept.adoc[ChannelConcept<T>]
* xref:reference:boost/gil/ChannelValueConcept.adoc[ChannelValueConcept<T>]
* xref:reference:boost/gil/MutableChannelConcept.adoc[MutableChannelConcept<T>]
* xref:reference:boost/gil/ChannelsCompatibleConcept.adoc[ChannelsCompatibleConcept<T1,T2>]
* xref:reference:boost/gil/ChannelConvertibleConcept.adoc[ChannelConvertibleConcept<SrcChannel,DstChannel>]
====
