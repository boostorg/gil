...
int main()
{
    ...
    write_view("out-morphology-example-dilation.png", view(img_out_dilation), png_tag{});
    operation = 1;
    convolve_2d_custom(view(img), ker_mat, view(img_out_erosion));
    write_view("out-morphology-example-erosion.png", view(img_out_erosion), png_tag{});
}
