...
int main(int argc, char* argv[])
{
    ...
    {
        // gil::generate_sobel_kernel({x_order, y_order}, size)
        // x_order : Order of derivative in horizontal direction.
        // y_order : Order of derivative in vertical direction.
        // size : Optional parameter which specifies desired size of resultant kernel.
