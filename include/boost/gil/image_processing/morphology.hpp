...
/// consideration. \param src_view - Source/Input image view. \param dst_view -
/// View which stores the final result of operations performed by this function.
/// \param kernel - Kernel matrix/structuring element containing 0's and 1's
/// which will be used for applying the required morphological operation. \param
...
/// input image. \param src_view - Source/Input image view. \param dst_view -
/// View which stores the final result of operations performed by this function.
/// \param kernel - Kernel matrix/structuring element containing 0's and 1's
/// which will be used for applying the required morphological operation. \param
/// identifier - Indicates the type of morphological operation to be applied.
...
/// and second image_view. \param src_view1 - First parameter for subtraction of
/// views. \param src_view2 - Second parameter for subtraction of views. \param
/// diff_view - View containing result of the subtraction of second view from
/// the first view. \tparam SrcView type of source/Input images used for
...
/// individual channel views of input images. \param src_view1 - First parameter
/// for subtraction of views. \param src_view2 - Second parameter for
/// subtraction of views. \param diff_view - View containing result of the
/// subtraction of second view from the first view. \tparam SrcView type of
/// source/Input images used for subtraction. \tparam DiffView type of image
/// view containing the result of subtraction.
template <typename SrcView, typename DiffView>
...
/// - Source/input image view. \param int_op_view - view for writing output and
/// performing intermediate operations. \param ker_mat - Kernel
/// matrix/structuring element containing 0's and 1's which will be used for
/// applying dilation. \param iterations - Specifies the number of times
/// dilation is to be applied on the input image view. \tparam SrcView type of
/// source image, models gil::ImageViewConcept. \tparam IntOpView type of output
/// image, models gil::MutableImageViewConcept. \tparam Kernel type of
/// structuring element.
...
/// performing intermediate operations. \param ker_mat - Kernel
/// matrix/structuring element containing 0's and 1's which will be used for
/// applying erosion. \param iterations - Specifies the number of times erosion
/// is to be applied on the input image view. \tparam SrcView type of source
/// image, models gil::ImageViewConcept. \tparam IntOpView type of output image,
/// models gil::MutableImageViewConcept. \tparam Kernel type of structuring
/// element.
template <typename SrcView, typename IntOpView, typename Kernel>
...
/// operation is utilized for removing noise from images. \param src_view -
/// Source/input image view. \param int_op_view - view for writing output and
/// performing intermediate operations. \param ker_mat - Kernel
/// matrix/structuring element containing 0's and 1's which will be used for
/// applying the opening operation. \tparam SrcView type of source image, models
/// gil::ImageViewConcept. \tparam IntOpView type of output image, models
...
/// utilized for closing small holes inside foreground objects. \param src_view
/// - Source/input image view. \param int_op_view - view for writing output and
/// performing intermediate operations. \param ker_mat - Kernel
/// matrix/structuring element containing 0's and 1's which will be used for
/// applying the closing operation. \tparam SrcView type of source image, models
/// gil::ImageViewConcept. \tparam IntOpView type of output image, models
/// gil::MutableImageViewConcept. \tparam Kernel type of structuring element.
template <typename SrcView, typename IntOpView, typename Kernel>
...
/// will look like the outline of the object(s) present in the image. \param
/// src_view - Source/input image view. \param dst_view - Destination view which
/// will store the final result of morphological gradient operation. \param
/// ker_mat - Kernel matrix/structuring element containing 0's and 1's which
/// will be used for applying the morphological gradient operation. \tparam
...
/// generated by opening operation on the input image view. \param src_view -
/// Source/input image view. \param dst_view - Destination view which will store
/// the final result of top hat operation. \param ker_mat - Kernel
/// matrix/structuring element containing 0's and 1's which will be used for
/// applying the top hat operation. \tparam SrcView type of source image, models
...
/// which will be used for applying the black hat operation. \tparam SrcView
/// type of source image, models gil::ImageViewConcept. \tparam DstView type of
/// output image, models gil::MutableImageViewConcept. \tparam Kernel type of
/// structuring element.
template <typename SrcView, typename DstView, typename Kernel>
