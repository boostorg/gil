...
struct is_read_supported< Pixel
                        , targa_tag
                        >
    : std::bool_constant< detail::targa_read_support< typename channel_type< Pixel >::type
...
struct is_write_supported< Pixel
                         , targa_tag
                         >
    : std::bool_constant< detail::targa_write_support< typename channel_type< Pixel >::type
                                             , typename color_space_type< Pixel >::type
                                             >::is_supported
                > {};
