...
: public std::add_lvalue_reference<typename std::add_const<ChannelReference>::type>
{
...
struct is_pixel< planar_pixel_reference<ChannelReference,ColorSpace> > : public std::true_type {};
