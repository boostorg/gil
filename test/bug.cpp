...
struct do_test : public ChannelTestCore {
    ...
    void test_channel_convert() {
      ...
      std::cout << "convert " << this->_min_v << ' ' << this->_max_v << std::endl;
...
{
    do_test<reference_core<bits32&> >().test_all();
